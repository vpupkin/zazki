...
var $strongName = 'CA46710148E6A9B1B5B4BEE368BAE5EF';
...
function doAttachChildren_0(){
  tryCommand(this, ($clinit_224() , attachCommand));
}

function doDetachChildren_0(){
  tryCommand(this, ($clinit_224() , detachCommand));
}
...
function $PopupPanel_0(this$static, autoHide){
  ...
  this$static.animType = ($clinit_282() , CENTER_0);
...
function $setPopupPosition(this$static, left, top_0){
  ...
  elem.style['left'] = left + ($clinit_84() , 'px');
...
function $initialize_0(this$static, options){
  ...
  $add_1(this$static, this$static.contentTable, ($clinit_237() , NORTH));
}
...
function $GWTCBox_0(this$static, style){
  ...
  $add_6(this$static.panel, this$static.title, ($clinit_237() , NORTH));
...
function objectToWidget(object){
  ...
  if (!object) {
    ...
    $equalsIgnoreCase(($clinit_56() , element).tagName, 'div') || $equalsIgnoreCase(element.tagName, 'span')?(html = (html_0 = $HTML_1(new HTML, element) , $onAttach(html_0) , $clinit_285() , $add_16(widgetsToDetach, html_0) , html_0)):(html = $GWTCBox$2(new GWTCBox$2, element));
  }
  return html;
}
...
function addMouseOutHandler(handler){
  return $addDomHandler(this, handler, ($clinit_134() , $clinit_134() , TYPE_8));
}

function addMouseOverHandler(handler){
  return $addDomHandler(this, handler, ($clinit_136() , $clinit_136() , TYPE_9));
}
...
function getText(){
  return ($clinit_56() , this.getElement_0()).textContent;
}
...
function $addMouseDownHandler(this$static, handler){
  return this$static.container?$addDomHandler(this$static.textPanel, handler, ($clinit_130() , $clinit_130() , TYPE_6)):$addDomHandler(this$static, handler, ($clinit_130() , $clinit_130() , TYPE_6));
}

function $addMouseOutHandler_0(this$static, handler){
  return this$static.container?$addDomHandler(this$static.textPanel, handler, ($clinit_134() , $clinit_134() , TYPE_8)):$addDomHandler(this$static, handler, ($clinit_134() , $clinit_134() , TYPE_8));
}

function $addMouseOverHandler_0(this$static, handler){
  return this$static.container?$addDomHandler(this$static.textPanel, handler, ($clinit_136() , $clinit_136() , TYPE_9)):$addDomHandler(this$static, handler, ($clinit_136() , $clinit_136() , TYPE_9));
}
...
function $setType(this$static, type){
  ...
  if (type == 0) {
    ...
    $addDomHandler(this$static.textPanel, this$static.focusHandler, ($clinit_103() , $clinit_103() , TYPE_3));
    $addDomHandler(this$static.textPanel, this$static.blurHandler, ($clinit_94() , $clinit_94() , TYPE_0));
    $addDomHandler(this$static.textPanel, this$static.keyPressHandler, ($clinit_125() , $clinit_125() , TYPE_4));
    $addDomHandler(this$static.textPanel, this$static.mouseDownHandler, ($clinit_130() , $clinit_130() , TYPE_6));
    $addDomHandler(this$static.textPanel, this$static.mouseOverHandler, ($clinit_136() , $clinit_136() , TYPE_9));
    $addDomHandler(this$static.textPanel, this$static.mouseOutHandler, ($clinit_134() , $clinit_134() , TYPE_8));
...
function addMouseOutHandler_0(handler){
  return this.container?$addDomHandler(this.textPanel, handler, ($clinit_134() , $clinit_134() , TYPE_8)):$addDomHandler(this, handler, ($clinit_134() , $clinit_134() , TYPE_8));
}

function addMouseOverHandler_0(handler){
  return this.container?$addDomHandler(this.textPanel, handler, ($clinit_136() , $clinit_136() , TYPE_9)):$addDomHandler(this, handler, ($clinit_136() , $clinit_136() , TYPE_9));
}
...
function getText_0(){
  return !this.container?($clinit_56() , !this.element && (this.element = this.element_0) , this.element).textContent:$getText_0(this.container, 0, this.textPosIdx);
}
...
function setText_0(txt){
  if (!this.container) {
    ($clinit_56() , !this.element && (this.element = this.element_0) , this.element).textContent = txt || '';
  }
   else {
...
function $clinit_25(){
  ...
  impl = ($clinit_301() , $clinit_301() , implPanel);
}
...
function $show_1(this$static){
  !this$static.attached && $add_5(($clinit_285() , get_0(null)), this$static, 0, 0);
...
function maximizeWidget(widget){
  ...
  if (!widget)
    return;
  w = max_1($doc.documentElement.clientWidth || $doc.body.clientWidth, max_1(getWindowScrollWidth(), ($clinit_285() , parseInt(get_0(null).element_0['offsetWidth']) || 0)));
...
function $setProgress_0(this$static, percentage, done, total){
  ...
  if (percentage > 0) {
    if (this$static.showRemaining) {
      ...
      ($clinit_56() , this$static.remainLabel.element_0).textContent = internationalize_0(remainText, '' + toString_9(remaining)) || '';
    }
  }
   else {
    this$static.startTime = fromDouble((new Date).getTime());
  ...
  if (this$static.showNumbers) {
    ...
    ($clinit_56() , this$static.numberLabel.element_0).textContent = internationalize(message, os) || '';
  }
}
...
function $clinit_94(){
  ...
  TYPE_0 = $DomEvent$Type(new DomEvent$Type, 'blur', ($clinit_94() , new BlurEvent));
}
...
function $clinit_96(){
  ...
  TYPE_1 = $DomEvent$Type(new DomEvent$Type, 'change', ($clinit_96() , new ChangeEvent));
}
...
function $clinit_101(){
  ...
  TYPE_2 = $DomEvent$Type(new DomEvent$Type, 'error', ($clinit_101() , new ErrorEvent));
}
...
function $clinit_103(){
  ...
  TYPE_3 = $DomEvent$Type(new DomEvent$Type, 'focus', ($clinit_103() , new FocusEvent));
}
...
function $clinit_125(){
  ...
  TYPE_4 = $DomEvent$Type(new DomEvent$Type, 'keypress', ($clinit_125() , new KeyPressEvent));
}
...
function $clinit_127(){
  ...
  TYPE_5 = $DomEvent$Type(new DomEvent$Type, 'load', ($clinit_127() , new LoadEvent));
}
...
function $clinit_130(){
  ...
  TYPE_6 = $DomEvent$Type(new DomEvent$Type, 'mousedown', ($clinit_130() , new MouseDownEvent));
}
...
function $clinit_132(){
  ...
  TYPE_7 = $DomEvent$Type(new DomEvent$Type, 'mousemove', ($clinit_132() , new MouseMoveEvent));
}
...
function $clinit_134(){
  ...
  TYPE_8 = $DomEvent$Type(new DomEvent$Type, 'mouseout', ($clinit_134() , new MouseOutEvent));
}
...
function $clinit_136(){
  ...
  TYPE_9 = $DomEvent$Type(new DomEvent$Type, 'mouseover', ($clinit_136() , new MouseOverEvent));
}
...
function $clinit_138(){
  ...
  TYPE_10 = $DomEvent$Type(new DomEvent$Type, 'mouseup', ($clinit_138() , new MouseUpEvent));
}
...
function init(){
  ...
  $export0_0();
  $export0();
  $schedule(($clinit_497() , $clinit_33() , new JsUpload$1), 1500);
}
...
function div_0(a, b){
  ...
  if (a[0] == 0 && a[1] == 0) {
    return $clinit_186() , ZERO;
  }
  if (eq(a, ($clinit_186() , MIN_VALUE))) {
...
function fromInt(value){
  ...
  if (value > -129 && value < 128) {
    rebase = value + 128;
    result = ($clinit_185() , boxedValues)[rebase];
...
function shru(a, n){
  ...
  n &= 63;
  sr = shr(a, n);
  a[1] < 0 && (sr = add_4(sr, shl(($clinit_186() , TWO), 63 - n)));
  return sr;
}
...
function toDoubleRoundDown(a){
  ...
  magnitute = round_int(Math.log(a[1]) / ($clinit_186() , LN_2));
  if (magnitute <= 48) {
    return a[1] + a[0];
  }
   else {
...
function onClosing(){
  var event_0;
  if (closeHandlersInitialized) {
    event_0 = ($clinit_208() , new Window$ClosingEvent);
...
function buildListParamMap(queryString){
  ...
  out = ($clinit_462() , $Collections$UnmodifiableMap(new Collections$UnmodifiableMap, out));
  return out;
}
...
function setText_1(text){
  ($clinit_56() , this.element_0).textContent = text || '';
}
...
function $DialogBox(this$static){
  ...
  $addDomHandler(this$static, mouseHandler, ($clinit_130() , $clinit_130() , TYPE_6));
  $addDomHandler(this$static, mouseHandler, ($clinit_138() , $clinit_138() , TYPE_10));
  $addDomHandler(this$static, mouseHandler, ($clinit_132() , $clinit_132() , TYPE_7));
  $addDomHandler(this$static, mouseHandler, ($clinit_136() , $clinit_136() , TYPE_9));
  $addDomHandler(this$static, mouseHandler, ($clinit_134() , $clinit_134() , TYPE_8));
  return this$static;
}
...
function setText_2(text){
  ($clinit_56() , this.caption.element_0).textContent = text || '';
}
...
function $Label_0(this$static, text){
  $Label(this$static);
  ($clinit_56() , this$static.element_0).textContent = text || '';
  return this$static;
}
...
function $DockPanel(this$static){
  ...
  this$static.horzAlign = ($clinit_263() , ALIGN_DEFAULT);
  this$static.vertAlign = ($clinit_267() , ALIGN_TOP);
...
function $DockPanel$LayoutData(this$static, dir){
  this$static.hAlign = ($clinit_263() , ALIGN_DEFAULT).textAlignString;
  this$static.vAlign = ($clinit_267() , ALIGN_TOP).verticalAlignString;
...
function addChangeHandler(handler){
  return $addDomHandler(this, handler, ($clinit_96() , $clinit_96() , TYPE_1));
}
...
function $getText_0(this$static, row, column){
  ...
  return ($clinit_56() , e).textContent;
}
...
function $fireSubmitEvent(this$static){
  var event_0;
  event_0 = ($clinit_253() , new FormPanel$SubmitEvent);
  !!this$static.handlerManager && $fireEvent_0(this$static.handlerManager, event_0);
...
function $onResize(){
  ...
  null.nullMethod(0 + ($clinit_84() , 'px'));
  null.nullMethod('0px');
...
function $onComplete(this$static){
  if (!this$static.showing) {
    ...
    $remove_2(($clinit_285() , get_0(null)), this$static.curPanel);
    $clinit_4();
  }
...
function $onInstantaneousRun(this$static){
  ...
  if (this$static.showing) {
    ...
    $add_4(($clinit_285() , get_0(null)), this$static.curPanel);
    $clinit_4();
  }
   else {
    $remove_2(($clinit_285() , get_0(null)), this$static.curPanel);
...
function $setState_0(this$static, showing){
  ...
  this$static.curPanel.animType != ($clinit_282() , CENTER_0) && !showing && (animate = false);
  this$static.showing = showing;
  if (animate) {
    if (showing) {
      $maybeShowGlass(this$static);
...
function $clinit_301(){
  ...
  implPanel?($clinit_301() , new FocusImpl):implPanel;
}
...
function $setClip(popup, rect){
  ...
  popup.style['display'] = ($clinit_68() , 'none');
  popup.style['display'] = '';
}
...
function execute_9(){
  this.val$outerElem.style['overflow'] = ($clinit_74() , 'auto');
}
...
function $generateText(this$static, curProgress){
  if (this$static.textFormatter) {
    return ($clinit_56() , this$static.textFormatter.this$0.fileNameLabel.element_0).textContent + '  (' + ~~Math.max(Math.min(curProgress, 2147483647), -2147483648) + ' %)';
  }
   else {
...
function $clinit_329(){
  ...
  impl_1 = ($clinit_343() , $clinit_343() , impl_2);
}
...
function build(node){
  ...
  nodeType = ($clinit_343() , out = node.nodeType , out == null?-1:out);
  switch (nodeType) {
    case 2:
...
function toString_11(){
  var jsNode;
  return $clinit_343() , jsNode = this.getJsObject() , (new XMLSerializer).serializeToString(jsNode);
}
...
function toString_12(){
  ...
  x = $split(($clinit_343() , this.jsObject.data), '(?=[;&<>\'"])', -1);
...
function toString_13(){
  ...
  $append_0(b, ($clinit_343() , this.jsObject.data));
  b.impl.string += ']]>';
  return b.impl.string;
}
...
function toString_15(){
  var b, i;
  b = $StringBuffer(new StringBuffer);
  for (i = 0; i < ($clinit_343() , this.jsObject.length); ++i) {
...
function $clinit_343(){
  ...
  impl_2 = $XMLParserImplStandard(new XMLParserImplStandard);
}
...
function $BaseUploadStatus(this$static){
  ...
  this$static.cancelCfg = ($clinit_370() , DEFAULT_CANCEL_CFG);
  this$static.i18nStrs = new IUploadStatus_UploadStatusConstants_;
  this$static.status_0 = ($clinit_372() , UNINITIALIZED);
...
function $setStatus(this$static, stat){
  ...
  switch (stat.ordinal) {
    ...
    case 5:
      ...
      !this$static.cancelCfg.contains(($clinit_371() , STOP_CURRENT)) && (this$static.cancelLabel.getElement_0().style.display = 'none' , undefined);
      break;
    case 9:
    case 7:
      $updateStatusPanel(this$static, false, this$static.i18nStrs.uploadStatusSuccess());
      !this$static.cancelCfg.contains(($clinit_371() , REMOVE_REMOTE)) && (this$static.cancelLabel.getElement_0().style.display = 'none' , undefined);
      break;
    case 1:
    ...
    case 0:
      ...
      this$static.cancelCfg.contains(($clinit_371() , REMOVE_CANCELLED_FROM_LIST)) && $removeFromParent(this$static.getWidget());
      break;
    case 4:
...
function $updateStatusPanel(this$static, showProgress, message){
  ...
  ($clinit_56() , this$static.statusLabel.element_0).textContent = message || '';
  $setVisible(this$static.cancelLabel, this$static.hasCancelActions && !this$static.cancelCfg.contains(($clinit_371() , DISABLED)));
}
...
function setError(msg){
  $setStatus(this, ($clinit_372() , ERROR));
  $wnd.alert($replaceAll(msg, '\\\\n', '\\n'));
}

function setFileName(name_0){
  ($clinit_56() , this.fileNameLabel.element_0).textContent = name_0 || '';
}
...
function setProgress_0(done, total){
  ...
  ($clinit_56() , this.statusMsg.element_0).textContent = percent + '%' || '';
}
...
function addChangeHandler_0(handler){
  return $addDomHandler(this.input, handler, ($clinit_96() , $clinit_96() , TYPE_1));
}
...
function $init_1(this$static, container, input){
  ...
  $addDomHandler(input, $DecoratedFileUpload$DecoratedFileUploadImplNoClick$1(new DecoratedFileUpload$DecoratedFileUploadImplNoClick$1, this$static), ($clinit_136() , $clinit_136() , TYPE_9));
  $addDomHandler(input, $DecoratedFileUpload$DecoratedFileUploadImplNoClick$2(new DecoratedFileUpload$DecoratedFileUploadImplNoClick$2, this$static), ($clinit_134() , $clinit_134() , TYPE_8));
}
...
function $IFileInput$ButtonFileInput(this$static){
  $DecoratedFileUpload(this$static, ($clinit_396() , 'Choose a file to upload ...'));
  return this$static;
}
...
function $IFileInput$LabelFileInput(this$static){
  ...
  $addDomHandler(this$static.input, $IFileInput$LabelFileInput$1(new IFileInput$LabelFileInput$1, this$static), ($clinit_96() , $clinit_96() , TYPE_1));
  return this$static;
}
...
function $clinit_370(){
  ...
  DEFAULT_CANCEL_CFG = of(($clinit_371() , REMOVE_REMOTE), initValues(_3Lgwtupload_client_IUploadStatus$CancelBehavior_2_classLit, 230, 37, [STOP_CURRENT]));
...
function getXmlNodeValue(doc, tag){
  ...
  list = $NodeListImpl(new NodeListImpl, ($clinit_343() , doc.jsObject.getElementsByTagNameNS('*', tag)));
...
function $MultiUploader_0(this$static, type, status_0){
  ...
  this$static.i18nStrs = ($clinit_396() , I18N_CONSTANTS);
...
function $getNonErroneousUploads(this$static){
  ...
  for (u$iterator = $AbstractList$IteratorImpl(new AbstractList$IteratorImpl, this$static.uploaders.arrayList); u$iterator.i < u$iterator.this$0.size_0();) {
    ...
    (u.getStatus() == ($clinit_372() , SUCCESS) || u.getStatus() == INPROGRESS || u.getStatus() == QUEUED || u.getStatus() == SUBMITING) && ++ret;
  }
  return ret;
}
...
function $newUploaderInstance(this$static){
  ...
  if (this$static.currentUploader) {
    ...
    if (status_0 == ($clinit_372() , UNINITIALIZED)) {
      return;
    }
...
function getStatus_0(){
  ...
  for (uploader$iterator = $AbstractList$IteratorImpl(new AbstractList$IteratorImpl, this.uploaders.arrayList); uploader$iterator.i < uploader$iterator.this$0.size_0();) {
    ...
    if (stat == ($clinit_372() , INPROGRESS) || stat == QUEUED || stat == SUBMITING) {
      return INPROGRESS;
    }
  }
  if (this.uploaders.arrayList.size <= 1) {
    return $clinit_372() , UNINITIALIZED;
  }
   else {
    return $clinit_372() , DONE;
  }
}
...
function onStatusChanged(uploader){
  var u, w;
  u = uploader;
  if (u.statusWidget.getStatus() == ($clinit_372() , CHANGED)) {
    ...
    w.getElement_0().style['position'] = ($clinit_79() , 'absolute');
    w.getElement_0().style['left'] = -4000 + ($clinit_84() , 'px');
...
function $setUrl_0(this$static, url){
  ...
  $add_4(($clinit_285() , get_0(null)), this$static);
  this$static.element_0.style.display = 'none';
}
...
function $Uploader_0(this$static, type, form){
  ...
  $addHandler(this$static.uploadForm, this$static.onSubmitFormHandler, ($clinit_253() , !TYPE_17 && (TYPE_17 = $GwtEvent$Type(new GwtEvent$Type)) , TYPE_17));
...
function $addToQueue(this$static){
  this$static.statusWidget.setStatus(($clinit_372() , QUEUED));
...
function $cancel_2(this$static){
  ...
  if (this$static.finished && !this$static.uploading) {
    if (this$static.successful) {
      try {
        reqBuilder = $RequestBuilder(new RequestBuilder, ($clinit_164() , GET), $composeURL(this$static, initValues(_3Ljava_lang_String_2_classLit, 240, 1, ['remove=' + this$static.fileInput.getName()])));
      ...
      this$static.statusWidget.setStatus(($clinit_372() , DELETED));
    }
    return;
  }
  ...
  if (this$static.uploading) {
    ...
    this$static.statusWidget.setStatus(($clinit_372() , CANCELING));
  }
   else {
...
function $cancelUpload(this$static, msg){
  ...
  $uploadFinished(this$static);
  this$static.statusWidget.setStatus(($clinit_372() , ERROR));
...
function $onChangeInput(this$static){
  ...
  this$static.statusWidget.setStatus(($clinit_372() , CHANGED));
...
function $parseAjaxResponse(this$static, responseTxt){
  ...
  doc = null;
  try {
    doc = ($clinit_329() , $parse(impl_1, responseTxt));
...
function $sendAjaxRequestToCancelCurrentUpload(this$static){
  var reqBuilder;
  reqBuilder = $RequestBuilder(new RequestBuilder, ($clinit_164() , GET), $composeURL(this$static, initValues(_3Ljava_lang_String_2_classLit, 240, 1, ['cancel=true'])));
...
function $sendAjaxRequestToGetBlobstorePath(this$static){
  var reqBuilder;
  reqBuilder = $RequestBuilder(new RequestBuilder, ($clinit_164() , GET), $composeURL(this$static, initValues(_3Ljava_lang_String_2_classLit, 240, 1, ['blobstore=true'])));
...
function $sendAjaxRequestToValidateSession(this$static){
  var reqBuilder;
  reqBuilder = $RequestBuilder(new RequestBuilder, ($clinit_164() , GET), $composeURL(this$static, initValues(_3Ljava_lang_String_2_classLit, 240, 1, ['new_session=true'])));
  $setTimeoutMillis(reqBuilder, 10000);
...
function $update_0(this$static){
  ...
  try {
    ...
    reqBuilder = $RequestBuilder(new RequestBuilder, ($clinit_164() , GET), $composeURL(this$static, initValues(_3Ljava_lang_String_2_classLit, 240, 1, ['filename=' + this$static.fileInput.getName(), 'c=' + this$static.requestsCounter++])));
    $setTimeoutMillis(reqBuilder, 10000);
  ...
  if (this$static.successful) {
    if (this$static.avoidRepeatedFiles) {
      if (!$containsKey(fileDone.map, this$static.fileInput.getFilename())) {
        ...
        this$static.statusWidget.setStatus(($clinit_372() , SUCCESS));
      }
    }
     else {
      this$static.statusWidget.setStatus(($clinit_372() , SUCCESS));
    ...
    this$static.cancelled?this$static.statusWidget.setStatus(($clinit_372() , CANCELED)):this$static.statusWidget.setStatus(($clinit_372() , ERROR));
...
function log(msg, e){
  ...
  if (!mlog) {
    if ((ensureParameterMap() , dynamicCast($get_2(paramMap, 'log'), 1)) != null) {
      mlog = $HTML(new HTML);
      $add_4(($clinit_285() , get_0(null)), mlog);
      log(msg, e);
    }
  }
   else {
...
function onFinishUpload_0(){
  $onFinishUpload(this);
  this.statusWidget.getStatus() == ($clinit_372() , REPEATED) && this.statusWidget.setError(this.i18nStrs.uploaderAlreadyDone());
...
function run_6(){
  if ($isTheFirstInQueue(this.this$0)) {
    $cancel_0(this);
    this.firstTime = true;
    this.this$0.statusWidget.setStatus(($clinit_372() , SUBMITING));
...
function $onSubmit(this$static, event_0){
  ...
  if (!this$static.this$0.finished && this$static.this$0.uploading) {
    ...
    this$static.this$0.statusWidget.setStatus(($clinit_372() , CANCELED));
    return;
  }
  if (!this$static.this$0.autoSubmit && ($clinit_396() , fileQueue).arrayList.size > 0) {
    this$static.this$0.statusWidget.setError(this$static.this$0.i18nStrs.uploaderActiveUpload());
    event_0.canceled = true;
    return;
  }
  if (this$static.this$0.avoidRepeatedFiles && $containsKey(($clinit_396() , fileDone).map, this$static.this$0.fileInput.getFilename())) {
    this$static.this$0.statusWidget.setStatus(($clinit_372() , REPEATED));
  ...
  if (this$static.this$0.autoSubmit) {
    ...
    this$static.this$0.statusWidget.setStatus(($clinit_372() , INPROGRESS));
    this$static.this$0.lastData = ($clinit_396() , fromDouble($getTime0($Date(new Date_0))));
  }
}
...
function run_7(){
  ...
  this.this$1.this$0.statusWidget.setStatus(($clinit_372() , INPROGRESS));
  this.this$1.this$0.lastData = ($clinit_396() , fromDouble($getTime0($Date(new Date_0))));
}
...
function onResponseReceived(request, response){
  ...
  url = null;
  try {
    url = getXmlNodeValue(($clinit_329() , $parse(impl_1, text)), 'blobpath');
  }
   catch ($e0) {
    $e0 = caught_0($e0);
    if (instanceOf($e0, 76)) {
...
function onError_0(request, exception){
  ...
  this.this$0.statusWidget.setStatus(($clinit_372() , CANCELED));
}

function onResponseReceived_0(request, response){
  this.this$0.statusWidget.getStatus() == ($clinit_372() , CANCELING) && $scheduleRepeating(this.this$0.updateStatusTimer, 3000);
}
...
function onError_1(request, exception){
  this.this$0.statusWidget.setStatus(($clinit_372() , DELETED));
  log('onCancelReceivedCallback onError: ', exception);
}

function onResponseReceived_1(request, response){
  this.this$0.statusWidget.setStatus(($clinit_372() , DELETED));
  $remove_11(($clinit_396() , fileDone).map, this.this$0.fileInput.getFilename()) != null;
}
...
function onChange_0(event_0){
  ...
  if (this.this$0.avoidRepeatedFiles && $containsKey(($clinit_396() , fileDone).map, this.this$0.fileInput.getFilename())) {
    this.this$0.statusWidget.setStatus(($clinit_372() , REPEATED));
    return;
  }
...
function onResponseReceived_2(request, response){
  ...
  try {
    s = getXmlNodeValue(($clinit_329() , $parse(impl_1, response.val$xmlHttpRequest.responseText)), 'blobstore');
...
function valueOf(i){
  ...
  if (i > -129 && i < 128) {
    rebase = i + 128;
    result = ($clinit_435() , boxedValues_0)[rebase];
...
function setFileName_0(name_0){
  !this.asDialog && (($clinit_56() , this.fileNameLabel.element_0).textContent = name_0 || '' , undefined);
  ($clinit_56() , this.prg.textLabel.element_0).textContent = name_0 || '';
}
...
function $PreloadImage(this$static, prop_0){
  ...
  this$static.thisInstance = this$static;
  this$static.loadHandler = $addHandler(this$static, this$static.imgLoadListener, ($clinit_127() , $clinit_127() , TYPE_5));
  this$static.errHandler = $addHandler(this$static, this$static.imgErrorListener, ($clinit_101() , $clinit_101() , TYPE_2));
...
function $Upload(this$static, prop_0){
  ...
  !this$static.panel && (this$static.panel = ($clinit_285() , get_0(null)));
