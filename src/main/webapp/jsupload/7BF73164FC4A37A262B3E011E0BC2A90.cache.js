...
var $strongName = '7BF73164FC4A37A262B3E011E0BC2A90';
...
function $center(this$static){
  ...
  $setPopupPosition(this$static, max_1($getScrollLeft_2(($clinit_57() , $doc).body) + left, 0), max_1(($doc.body.scrollTop || 0) + top_0, 0));
  if (!initiallyShowing) {
...
function $clinit_11(){
  ...
  impl = ($clinit_296() , $clinit_296() , implWidget);
}
...
function setFocus(focused){
  focused?impl.focus_0(this.getElement_0()):impl.blur_0(this.getElement_0());
}
...
function getText(){
  return $getInnerText(($clinit_57() , impl_1), this.getElement_0());
}
...
function $Button(this$static){
  var e;
  $clinit_13();
  $ButtonBase(this$static, (e = ($clinit_57() , $doc).createElement('BUTTON') , e.setAttribute('type', 'button') , e));
...
function getText_0(){
  return !this.container?$getInnerText(($clinit_57() , impl_1), (!this.element && (this.element = this.element_0) , this.element)):$getText_0(this.container, 0, this.textPosIdx);
}
...
function $clinit_25(){
  ...
  impl_0 = ($clinit_296() , $clinit_296() , implPanel);
}
...
function $setFocus_1(this$static, focused){
  focused?$focus_0(this$static.element_0):$blur_1(this$static.element_0);
}
...
function $clinit_57(){
  ...
  impl_1 = ($clinit_59() , $clinit_58() , $clinit_57() , new DOMImplSafari);
}
...
function $getScrollLeft_2(this$static){
  return $getScrollLeft_0(($clinit_57() , this$static));
}
...
function $getX(this$static){
  ...
  if (relativeElem) {
    return e = this$static.nativeEvent , (($clinit_57() , e).clientX || 0) - $getAbsoluteLeft(relativeElem) + $getScrollLeft_0(relativeElem) + $getScrollLeft_0(relativeElem.ownerDocument.body);
  }
...
function init(){
  ...
  $export0_0();
  $export0();
  $schedule(($clinit_491() , $clinit_33() , new JsUpload$1), 1500);
}
...
function $clinit_201(){
  ...
  impl_2 = $HistoryImplSafari(new HistoryImplSafari);
...
function buildListParamMap(queryString){
  ...
  out = ($clinit_456() , $Collections$UnmodifiableMap(new Collections$UnmodifiableMap, out));
  return out;
}
...
function $getText_0(this$static, row, column){
  ...
  return $getInnerText(($clinit_57() , impl_1), e);
}
...
function $clinit_296(){
  ...
  implWidget = implPanel?($clinit_296() , new FocusImpl):implPanel;
}
...
function $clinit_323(){
  ...
  impl_3 = ($clinit_337() , $clinit_337() , impl_4);
}
...
function build(node){
  ...
  nodeType = ($clinit_337() , out = node.nodeType , out == null?-1:out);
  switch (nodeType) {
    case 2:
...
function toString_11(){
  var jsNode;
  return $clinit_337() , jsNode = this.getJsObject() , (new XMLSerializer).serializeToString(jsNode);
}
...
function toString_12(){
  ...
  x = $split(($clinit_337() , this.jsObject.data), '(?=[;&<>\'"])', -1);
...
function toString_13(){
  ...
  $append_0(b, ($clinit_337() , this.jsObject.data));
  b.impl.string += ']]>';
  return b.impl.string;
}
...
function toString_15(){
  var b, i;
  b = $StringBuffer(new StringBuffer);
  for (i = 0; i < ($clinit_337() , this.jsObject.length); ++i) {
...
function $clinit_337(){
  ...
  impl_4 = $XMLParserImplSafari(new XMLParserImplSafari);
}
...
function $parse(this$static, contents){
  ...
  try {
    ...
    if (instanceOf($e0, 48)) {
      e = $e0;
      throw $DOMParseException_0(new DOMParseException, contents, e);
    }
     else 
      throw $e0;
  }
...
function throwDOMParseException(message){
  throw $DOMParseException(new DOMParseException, message);
}
...
function $BaseUploadStatus(this$static){
  ...
  this$static.cancelCfg = ($clinit_364() , DEFAULT_CANCEL_CFG);
  this$static.i18nStrs = new IUploadStatus_UploadStatusConstants_;
  this$static.status_0 = ($clinit_366() , UNINITIALIZED);
...
function $setStatus(this$static, stat){
  ...
  switch (stat.ordinal) {
    ...
    case 5:
      ...
      !this$static.cancelCfg.contains(($clinit_365() , STOP_CURRENT)) && (this$static.cancelLabel.getElement_0().style.display = 'none' , undefined);
      break;
    case 9:
    case 7:
      $updateStatusPanel(this$static, false, this$static.i18nStrs.uploadStatusSuccess());
      !this$static.cancelCfg.contains(($clinit_365() , REMOVE_REMOTE)) && (this$static.cancelLabel.getElement_0().style.display = 'none' , undefined);
      break;
    case 1:
    ...
    case 0:
      ...
      this$static.cancelCfg.contains(($clinit_365() , REMOVE_CANCELLED_FROM_LIST)) && $removeFromParent(this$static.getWidget());
      break;
    case 4:
...
function $updateStatusPanel(this$static, showProgress, message){
  ...
  $setVisible(this$static.cancelLabel, this$static.hasCancelActions && !this$static.cancelCfg.contains(($clinit_365() , DISABLED)));
}
...
function setError(msg){
  $setStatus(this, ($clinit_366() , ERROR));
...
function $DecoratedFileUpload(this$static, text){
  ...
  this$static.impl = ($clinit_347() , new DecoratedFileUpload$DecoratedFileUploadImplClick);
...
function $init_1(this$static, container, input){
  ...
  beforeIndex = container.children.size;
...
function $IFileInput$ButtonFileInput(this$static){
  $DecoratedFileUpload(this$static, ($clinit_390() , 'Choose a file to upload ...'));
  return this$static;
}
...
function $clinit_364(){
  ...
  DEFAULT_CANCEL_CFG = of(($clinit_365() , REMOVE_REMOTE), initValues(_3Lgwtupload_client_IUploadStatus$CancelBehavior_2_classLit, 229, 36, [STOP_CURRENT]));
...
function getXmlNodeValue(doc, tag){
  ...
  list = $NodeListImpl(new NodeListImpl, ($clinit_337() , doc.jsObject.getElementsByTagName(tag)));
...
function $MultiUploader_0(this$static, type, status_0){
  ...
  this$static.i18nStrs = ($clinit_390() , I18N_CONSTANTS);
...
function $getNonErroneousUploads(this$static){
  ...
  for (u$iterator = $AbstractList$IteratorImpl(new AbstractList$IteratorImpl, this$static.uploaders.arrayList); u$iterator.i < u$iterator.this$0.size_0();) {
    ...
    (u.getStatus() == ($clinit_366() , SUCCESS) || u.getStatus() == INPROGRESS || u.getStatus() == QUEUED || u.getStatus() == SUBMITING) && ++ret;
  }
  return ret;
}
...
function $newUploaderInstance(this$static){
  ...
  if (this$static.currentUploader) {
    ...
    if (status_0 == ($clinit_366() , UNINITIALIZED)) {
      return;
    }
...
function getStatus_0(){
  ...
  for (uploader$iterator = $AbstractList$IteratorImpl(new AbstractList$IteratorImpl, this.uploaders.arrayList); uploader$iterator.i < uploader$iterator.this$0.size_0();) {
    ...
    if (stat == ($clinit_366() , INPROGRESS) || stat == QUEUED || stat == SUBMITING) {
      return INPROGRESS;
    }
  }
  if (this.uploaders.arrayList.size <= 1) {
    return $clinit_366() , UNINITIALIZED;
  }
   else {
    return $clinit_366() , DONE;
  }
}
...
function onStatusChanged(uploader){
  var u, w;
  u = uploader;
  if (u.statusWidget.getStatus() == ($clinit_366() , CHANGED)) {
...
function $addToQueue(this$static){
  this$static.statusWidget.setStatus(($clinit_366() , QUEUED));
...
function $cancel_2(this$static){
  ...
  if (this$static.finished && !this$static.uploading) {
    if (this$static.successful) {
      try {
        reqBuilder = $RequestBuilder(new RequestBuilder, ($clinit_160() , GET), $composeURL(this$static, initValues(_3Ljava_lang_String_2_classLit, 239, 1, ['remove=' + this$static.fileInput.getName()])));
      ...
      this$static.statusWidget.setStatus(($clinit_366() , DELETED));
    }
    return;
  }
  ...
  if (this$static.uploading) {
    ...
    this$static.statusWidget.setStatus(($clinit_366() , CANCELING));
  }
   else {
...
function $cancelUpload(this$static, msg){
  ...
  $uploadFinished(this$static);
  this$static.statusWidget.setStatus(($clinit_366() , ERROR));
...
function $onChangeInput(this$static){
  ...
  this$static.statusWidget.setStatus(($clinit_366() , CHANGED));
...
function $parseAjaxResponse(this$static, responseTxt){
  ...
  doc = null;
  try {
    doc = ($clinit_323() , $parse(impl_3, responseTxt));
...
function $sendAjaxRequestToCancelCurrentUpload(this$static){
  var reqBuilder;
  reqBuilder = $RequestBuilder(new RequestBuilder, ($clinit_160() , GET), $composeURL(this$static, initValues(_3Ljava_lang_String_2_classLit, 239, 1, ['cancel=true'])));
...
function $sendAjaxRequestToGetBlobstorePath(this$static){
  var reqBuilder;
  reqBuilder = $RequestBuilder(new RequestBuilder, ($clinit_160() , GET), $composeURL(this$static, initValues(_3Ljava_lang_String_2_classLit, 239, 1, ['blobstore=true'])));
...
function $sendAjaxRequestToValidateSession(this$static){
  var reqBuilder;
  reqBuilder = $RequestBuilder(new RequestBuilder, ($clinit_160() , GET), $composeURL(this$static, initValues(_3Ljava_lang_String_2_classLit, 239, 1, ['new_session=true'])));
  $setTimeoutMillis(reqBuilder, 10000);
...
function $update_0(this$static){
  ...
  try {
    ...
    reqBuilder = $RequestBuilder(new RequestBuilder, ($clinit_160() , GET), $composeURL(this$static, initValues(_3Ljava_lang_String_2_classLit, 239, 1, ['filename=' + this$static.fileInput.getName(), 'c=' + this$static.requestsCounter++])));
    $setTimeoutMillis(reqBuilder, 10000);
  ...
  if (this$static.successful) {
    if (this$static.avoidRepeatedFiles) {
      if (!$containsKey(fileDone.map, this$static.fileInput.getFilename())) {
        ...
        this$static.statusWidget.setStatus(($clinit_366() , SUCCESS));
      }
    }
     else {
      this$static.statusWidget.setStatus(($clinit_366() , SUCCESS));
    ...
    this$static.cancelled?this$static.statusWidget.setStatus(($clinit_366() , CANCELED)):this$static.statusWidget.setStatus(($clinit_366() , ERROR));
...
function onFinishUpload_0(){
  $onFinishUpload(this);
  this.statusWidget.getStatus() == ($clinit_366() , REPEATED) && this.statusWidget.setError(this.i18nStrs.uploaderAlreadyDone());
...
function run_6(){
  if ($isTheFirstInQueue(this.this$0)) {
    $cancel_0(this);
    this.firstTime = true;
    this.this$0.statusWidget.setStatus(($clinit_366() , SUBMITING));
...
function $onSubmit(this$static, event_0){
  ...
  if (!this$static.this$0.finished && this$static.this$0.uploading) {
    ...
    this$static.this$0.statusWidget.setStatus(($clinit_366() , CANCELED));
    return;
  }
  if (!this$static.this$0.autoSubmit && ($clinit_390() , fileQueue).arrayList.size > 0) {
    this$static.this$0.statusWidget.setError(this$static.this$0.i18nStrs.uploaderActiveUpload());
    event_0.canceled = true;
    return;
  }
  if (this$static.this$0.avoidRepeatedFiles && $containsKey(($clinit_390() , fileDone).map, this$static.this$0.fileInput.getFilename())) {
    this$static.this$0.statusWidget.setStatus(($clinit_366() , REPEATED));
  ...
  if (this$static.this$0.autoSubmit) {
    ...
    this$static.this$0.statusWidget.setStatus(($clinit_366() , INPROGRESS));
    this$static.this$0.lastData = ($clinit_390() , fromDouble($getTime0($Date(new Date_0))));
  }
}
...
function run_7(){
  ...
  this.this$1.this$0.statusWidget.setStatus(($clinit_366() , INPROGRESS));
  this.this$1.this$0.lastData = ($clinit_390() , fromDouble($getTime0($Date(new Date_0))));
}
...
function onResponseReceived(request, response){
  ...
  url = null;
  try {
    url = getXmlNodeValue(($clinit_323() , $parse(impl_3, text)), 'blobpath');
  }
   catch ($e0) {
    $e0 = caught_0($e0);
    if (instanceOf($e0, 77)) {
...
function onError_0(request, exception){
  ...
  this.this$0.statusWidget.setStatus(($clinit_366() , CANCELED));
}

function onResponseReceived_0(request, response){
  this.this$0.statusWidget.getStatus() == ($clinit_366() , CANCELING) && $scheduleRepeating(this.this$0.updateStatusTimer, 3000);
}
...
function onError_1(request, exception){
  this.this$0.statusWidget.setStatus(($clinit_366() , DELETED));
  log('onCancelReceivedCallback onError: ', exception);
}

function onResponseReceived_1(request, response){
  this.this$0.statusWidget.setStatus(($clinit_366() , DELETED));
  $remove_11(($clinit_390() , fileDone).map, this.this$0.fileInput.getFilename()) != null;
}
...
function onChange_0(event_0){
  ...
  if (this.this$0.avoidRepeatedFiles && $containsKey(($clinit_390() , fileDone).map, this.this$0.fileInput.getFilename())) {
    this.this$0.statusWidget.setStatus(($clinit_366() , REPEATED));
    return;
  }
...
function onResponseReceived_2(request, response){
  ...
  try {
    s = getXmlNodeValue(($clinit_323() , $parse(impl_3, response.val$xmlHttpRequest.responseText)), 'blobstore');
...
function valueOf(i){
  ...
  if (i > -129 && i < 128) {
    rebase = i + 128;
    result = ($clinit_429() , boxedValues_0)[rebase];
...
function $getText_1(this$static, curProgress){
  return $getInnerText(($clinit_57() , impl_1), this$static.this$0.fileNameLabel.element_0) + '  (' + ~~Math.max(Math.min(curProgress, 2147483647), -2147483648) + ' %)';
}
...
function $export0(){
  ...
  ;
  $clinit_505();
  $put_0(impl_5.typeMap, 'jsupload.client.PreloadImage', $wnd.jsu.PreloadImage);
}
...
function $export0_0(){
  ...
  ;
  $clinit_505();
  $put_0(impl_5.typeMap, 'jsupload.client.Upload', $wnd.jsu.Upload);
}
...
_.typeId$ = 0;
function $clinit_505(){
  $clinit_505 = nullMethod;
  impl_5 = $ExporterBaseActual(new ExporterBaseActual);
}
