...
var $strongName = 'B5CC162438521440EDB14D4C9ECC23C3';
...
function $toString(this$static){
  ...
  return ($clinit_55() , this$static.getElement_0()).outerHTML;
}
...
function $onBrowserEvent(this$static, event_0){
  var related;
  switch ($eventGetTypeInt(($clinit_55() , event_0).type)) {
    case 16:
    case 32:
...
function doAttachChildren_0(){
  tryCommand(this, ($clinit_223() , attachCommand));
}

function doDetachChildren_0(){
  tryCommand(this, ($clinit_223() , detachCommand));
}
...
function $SimplePanel(this$static){
  this$static.element_0 = $createElement(($clinit_55() , $doc), 'div');
  return this$static;
}
...
function $PopupPanel_0(this$static, autoHide){
  ...
  this$static.animType = ($clinit_281() , CENTER_0);
...
function $center(this$static){
  ...
  $setPopupPosition(this$static, max_1($getScrollLeft(($clinit_55() , $doc)) + left, 0), max_1($getScrollTop($doc) + top_0, 0));
  if (!initiallyShowing) {
...
function $eventTargetsPopup(this$static, event_0){
  var target;
  target = ($clinit_55() , event_0).srcElement;
  if (is_0(target)) {
...
function $previewNativeEvent(this$static, event_0){
  ...
  this$static.modal && (event_0.isCanceled = true);
  type = $eventGetTypeInt(($clinit_55() , nativeEvent).type);
  switch (type) {
    case 128:
      {
...
function $setPopupPosition(this$static, left, top_0){
  ...
  left -= $getBodyOffsetLeft(($clinit_55() , $doc));
  top_0 -= $getBodyOffsetTop($doc);
  elem = this$static.element_0;
  elem.style['left'] = left + ($clinit_79() , 'px');
...
function getContainerElement_0(){
  return $getFirstChildElement(($clinit_55() , this.element_0));
}
...
function getStyleElement_0(){
  return $getStyleElement_1($getFirstChildElement(($clinit_55() , this.element_0)));
}
...
function $initialize(this$static, options){
  ...
  $getStyleElement_1($getFirstChildElement(($clinit_55() , this$static.element_0)))['className'] = 'GWTCPopupBox';
...
function $initialize_0(this$static, options){
  ...
  $getStyleElement_1($getFirstChildElement(($clinit_55() , this$static.element_0)))['className'] = 'GWTCAlert';
  ...
  $add_1(this$static, this$static.contentTable, ($clinit_236() , NORTH));
}
...
function $clinit_8(){
  $clinit_8 = nullMethod;
  DEFAULT_ROW_STYLENAMES = initValues(_3Ljava_lang_String_2_classLit, 239, 1, ['top', 'middle', 'bottom']);
}

function $DecoratorPanel(this$static, rowStyles, containerIndex){
  var i, row, table, trElem;
  $clinit_8();
  this$static.element_0 = $createElement(($clinit_55() , $doc), 'table');
...
function createTD(styleName){
  var inner, tdElem;
  tdElem = $createElement(($clinit_55() , $doc), 'td');
...
function $GWTCBox_0(this$static, style){
  ...
  $add_6(this$static.panel, this$static.title, ($clinit_236() , NORTH));
...
function objectToWidget(object){
  ...
  if (!object) {
    ...
    $equalsIgnoreCase($getTagName(($clinit_55() , element)), 'div') || $equalsIgnoreCase($getTagName(element), 'span')?(html = (html_0 = $HTML_1(new HTML, element) , $onAttach(html_0) , $clinit_284() , $add_16(widgetsToDetach, html_0) , html_0)):(html = $GWTCBox$2(new GWTCBox$2, element));
  }
  return html;
}
...
function addMouseOutHandler(handler){
  return $addDomHandler(this, handler, ($clinit_129() , $clinit_129() , TYPE_8));
}

function addMouseOverHandler(handler){
  return $addDomHandler(this, handler, ($clinit_131() , $clinit_131() , TYPE_9));
}
...
function getText(){
  return ($clinit_55() , this.getElement_0()).innerText;
}
...
function setText(text){
  ($clinit_55() , this.getElement_0()).innerText = text || '';
}
...
function $Button(this$static){
  $ButtonBase(this$static, ($clinit_55() , $doc).createElement("<BUTTON type='button'><\/BUTTON>"));
...
function $addMouseDownHandler(this$static, handler){
  return this$static.container?$addDomHandler(this$static.textPanel, handler, ($clinit_125() , $clinit_125() , TYPE_6)):$addDomHandler(this$static, handler, ($clinit_125() , $clinit_125() , TYPE_6));
}

function $addMouseOutHandler_0(this$static, handler){
  return this$static.container?$addDomHandler(this$static.textPanel, handler, ($clinit_129() , $clinit_129() , TYPE_8)):$addDomHandler(this$static, handler, ($clinit_129() , $clinit_129() , TYPE_8));
}

function $addMouseOverHandler_0(this$static, handler){
  return this$static.container?$addDomHandler(this$static.textPanel, handler, ($clinit_131() , $clinit_131() , TYPE_9)):$addDomHandler(this$static, handler, ($clinit_131() , $clinit_131() , TYPE_9));
}
...
function $replaceElement_1(this$static, element){
  ...
  if (this$static.element) {
    parent_0 = (parent_1 = ($clinit_55() , this$static.element).parentNode , (!parent_1 || parent_1.nodeType != 1) && (parent_1 = null) , parent_1);
    if (parent_0) {
...
function $setType(this$static, type){
  var text;
  text = !this$static.container?($clinit_55() , !this$static.element && (this$static.element = this$static.element_0) , this$static.element).innerHTML:($clinit_55() , $getElement_1(this$static.container.cellFormatter, 0, this$static.textPosIdx)).innerHTML;
  ...
  if (type == 0) {
    ...
    $addDomHandler(this$static.textPanel, this$static.focusHandler, ($clinit_98() , $clinit_98() , TYPE_3));
    $addDomHandler(this$static.textPanel, this$static.blurHandler, ($clinit_89() , $clinit_89() , TYPE_0));
    $addDomHandler(this$static.textPanel, this$static.keyPressHandler, ($clinit_120() , $clinit_120() , TYPE_4));
    $addDomHandler(this$static.textPanel, this$static.mouseDownHandler, ($clinit_125() , $clinit_125() , TYPE_6));
    $addDomHandler(this$static.textPanel, this$static.mouseOverHandler, ($clinit_131() , $clinit_131() , TYPE_9));
    $addDomHandler(this$static.textPanel, this$static.mouseOutHandler, ($clinit_129() , $clinit_129() , TYPE_8));
...
function addMouseOutHandler_0(handler){
  return this.container?$addDomHandler(this.textPanel, handler, ($clinit_129() , $clinit_129() , TYPE_8)):$addDomHandler(this, handler, ($clinit_129() , $clinit_129() , TYPE_8));
}

function addMouseOverHandler_0(handler){
  return this.container?$addDomHandler(this.textPanel, handler, ($clinit_131() , $clinit_131() , TYPE_9)):$addDomHandler(this, handler, ($clinit_131() , $clinit_131() , TYPE_9));
}
...
function getText_0(){
  return !this.container?($clinit_55() , !this.element && (this.element = this.element_0) , this.element).innerText:$getText_0(this.container, 0, this.textPosIdx);
}

function onBrowserEvent_0(event_0){
  var mevent;
  mevent = $eventGetTypeInt(($clinit_55() , event_0).type);
  if (this.enabled) {
    if (mevent == 1) {
...
function setText_0(txt){
  if (!this.container) {
    ($clinit_55() , !this.element && (this.element = this.element_0) , this.element).innerText = txt || '';
  }
   else {
...
function fireNativeEvent(nativeEvent, handlerSource, relativeElem){
  ...
  if (registered) {
    typeKey = dynamicCast(registered.map[($clinit_55() , nativeEvent).type], 9);
    if (typeKey) {
...
function $show_1(this$static){
  !this$static.attached && $add_5(($clinit_284() , get_0(null)), this$static, 0, 0);
...
function internationalize_0(s, o){
  var os;
  os = initValues(_3Ljava_lang_Object_2_classLit, 237, 0, [o]);
...
function maximizeWidget(widget){
  ...
  if (!widget)
    return;
  w = max_1($doc.documentElement.clientWidth || $doc.body.clientWidth, max_1(getWindowScrollWidth(), ($clinit_284() , parseInt(get_0(null).element_0['offsetWidth']) || 0)));
...
function $setProgress_0(this$static, percentage, done, total){
  ...
  if (percentage > 0) {
    if (this$static.showRemaining) {
      ...
      ($clinit_55() , this$static.remainLabel.element_0).innerText = internationalize_0(remainText, '' + toString_9(remaining)) || '';
    }
  }
   else {
    this$static.startTime = fromDouble((new Date).getTime());
  ...
  if (this$static.showNumbers) {
    ...
    os = initValues(_3Ljava_lang_Object_2_classLit, 237, 0, ['' + percentage, '' + done, '' + total, '' + toString_9(velocity)]);
    ($clinit_55() , this$static.numberLabel.element_0).innerText = internationalize(message, os) || '';
  }
}
...
function $setStackTrace(stackTrace){
  var c, copy, i;
  copy = initDim(_3Ljava_lang_StackTraceElement_2_classLit, 238, 44, stackTrace.length, 0);
...
function $createStackTrace(e){
  ...
  stackTrace = initDim(_3Ljava_lang_StackTraceElement_2_classLit, 238, 44, stack.length, 0);
...
function $getScrollLeft(doc){
  return $getScrollLeft_1(($clinit_55() , $equals_1(doc.compatMode, 'CSS1Compat')?doc.documentElement:doc.body));
}
...
function $createElement(doc, tagName){
  ...
  if (tagName.indexOf(':') != -1) {
    ...
    elem = $getFirstChildElement(($clinit_55() , container));
...
function $getAbsoluteLeft(elem){
  ...
  return $getBoundingClientRectLeft(elem) + $getScrollLeft(($clinit_55() , doc));
}

function $getAbsoluteTop(elem){
  var doc;
  doc = elem.ownerDocument;
  return $getBoundingClientRectTop(elem) + $getScrollTop(($clinit_55() , doc));
}
...
function values_1(){
  $clinit_74();
  return initValues(_3Lcom_google_gwt_dom_client_Style$Position_2_classLit, 218, 26, [STATIC, RELATIVE, ABSOLUTE, FIXED]);
}
...
function values_2(){
  $clinit_79();
  return initValues(_3Lcom_google_gwt_dom_client_Style$Unit_2_classLit, 219, 27, [PX, PCT, EM, EX, PT, PC, IN, CM, MM]);
}
...
function $clinit_89(){
  ...
  TYPE_0 = $DomEvent$Type(new DomEvent$Type, 'blur', ($clinit_89() , new BlurEvent));
}
...
function $clinit_91(){
  ...
  TYPE_1 = $DomEvent$Type(new DomEvent$Type, 'change', ($clinit_91() , new ChangeEvent));
}
...
function $clinit_96(){
  ...
  TYPE_2 = $DomEvent$Type(new DomEvent$Type, 'error', ($clinit_96() , new ErrorEvent));
}
...
function $clinit_98(){
  ...
  TYPE_3 = $DomEvent$Type(new DomEvent$Type, 'focus', ($clinit_98() , new FocusEvent));
}
...
function $clinit_120(){
  ...
  TYPE_4 = $DomEvent$Type(new DomEvent$Type, 'keypress', ($clinit_120() , new KeyPressEvent));
}
...
function $clinit_122(){
  ...
  TYPE_5 = $DomEvent$Type(new DomEvent$Type, 'load', ($clinit_122() , new LoadEvent));
}
...
function $getX(this$static){
  ...
  if (relativeElem) {
    return e = this$static.nativeEvent , (($clinit_55() , e).clientX || 0) - (doc = relativeElem.ownerDocument , $getBoundingClientRectLeft(relativeElem) + $getScrollLeft_1($equals_1(doc.compatMode, 'CSS1Compat')?doc.documentElement:doc.body)) + $getScrollLeft_1(relativeElem) + $getScrollLeft(relativeElem.ownerDocument);
  }
  return ($clinit_55() , this$static.nativeEvent).clientX || 0;
}
...
function $getY(this$static){
  ...
  relativeElem = this$static.relativeElem;
  if (relativeElem) {
    return e = this$static.nativeEvent , (($clinit_55() , e).clientY || 0) - (doc = relativeElem.ownerDocument , $getBoundingClientRectTop(relativeElem) + (($equals_1(doc.compatMode, 'CSS1Compat')?doc.documentElement:doc.body).scrollTop || 0)) + (relativeElem.scrollTop || 0) + $getScrollTop(relativeElem.ownerDocument);
  }
  return ($clinit_55() , this$static.nativeEvent).clientY || 0;
}
...
function $clinit_125(){
  ...
  TYPE_6 = $DomEvent$Type(new DomEvent$Type, 'mousedown', ($clinit_125() , new MouseDownEvent));
}
...
function $clinit_127(){
  ...
  TYPE_7 = $DomEvent$Type(new DomEvent$Type, 'mousemove', ($clinit_127() , new MouseMoveEvent));
}
...
function $clinit_129(){
  ...
  TYPE_8 = $DomEvent$Type(new DomEvent$Type, 'mouseout', ($clinit_129() , new MouseOutEvent));
}
...
function $clinit_131(){
  ...
  TYPE_9 = $DomEvent$Type(new DomEvent$Type, 'mouseover', ($clinit_131() , new MouseOverEvent));
}
...
function $clinit_133(){
  ...
  TYPE_10 = $DomEvent$Type(new DomEvent$Type, 'mouseup', ($clinit_133() , new MouseUpEvent));
}
...
function init(){
  ...
  $export0_0();
  $export0();
  $schedule(($clinit_494() , $clinit_33() , new JsUpload$1), 1500);
}
...
function div_0(a, b){
  ...
  if (a[0] == 0 && a[1] == 0) {
    return $clinit_181() , ZERO;
  }
  if (eq(a, ($clinit_181() , MIN_VALUE))) {
...
function fromDouble(value){
  ...
  if (value < -9223372036854775808) {
    return $clinit_181() , MIN_VALUE;
  }
  if (value >= 9223372036854775807) {
    return $clinit_181() , MAX_VALUE;
  }
  if (value > 0) {
...
function fromInt(value){
  ...
  if (value > -129 && value < 128) {
    rebase = value + 128;
    result = ($clinit_180() , boxedValues)[rebase];
...
function shru(a, n){
  ...
  n &= 63;
  sr = shr(a, n);
  a[1] < 0 && (sr = add_4(sr, shl(($clinit_181() , TWO), 63 - n)));
  return sr;
}
...
function toDoubleRoundDown(a){
  ...
  magnitute = round_int(Math.log(a[1]) / ($clinit_181() , LN_2));
  if (magnitute <= 48) {
    return a[1] + a[0];
  }
   else {
...
function $clinit_180(){
  ...
  boxedValues = initDim(_3_3D_classLit, 241, 46, 256, 0);
}
...
function dispatchEvent_0(evt, elem, listener){
  ...
  currentEvent = evt;
  elem == sCaptureElem && $eventGetTypeInt(($clinit_55() , evt).type) == 8192 && (sCaptureElem = null);
...
function previewEvent(evt){
  ...
  if (!ret && !!evt) {
    ...
    ($clinit_55() , evt).returnValue = false;
  }
  return ret;
}
...
function buildListParamMap(queryString){
  ...
  out = ($clinit_459() , $Collections$UnmodifiableMap(new Collections$UnmodifiableMap, out));
  return out;
}
...
function $initHandler(initFunc, cmd){
  var scriptElem;
  scriptElem = $createScriptElement(($clinit_55() , $doc), initFunc);
...
function $remove_1(this$static, w){
  ...
  try {
    ...
    elem = w.getElement_0();
    (parent_0 = ($clinit_55() , elem).parentNode , (!parent_0 || parent_0.nodeType != 1) && (parent_0 = null) , parent_0).removeChild(elem);
...
function $AbsolutePanel(this$static){
  $AbsolutePanel_0(this$static, $createElement(($clinit_55() , $doc), 'div'));
...
function $Anchor(this$static){
  $setElement_0(this$static, $createElement(($clinit_55() , $doc), 'a'));
...
function setText_1(text){
  ($clinit_55() , this.element_0).innerText = text || '';
}
...
function $AttachDetachException(this$static, causes){
  $clinit_223();
  $Throwable(this$static, 'One or more exceptions caught, see full set in AttachDetachException#getCauses', causes.map.size == 0?null:dynamicCast($toArray(causes, initDim(_3Ljava_lang_Throwable_2_classLit, 240, 45, 0, 0)), 54)[0]);
  return this$static;
}
...
function $CellPanel(this$static){
  this$static.children_0 = $WidgetCollection(new WidgetCollection, this$static);
  this$static.table = $createElement(($clinit_55() , $doc), 'table');
...
function $DialogBox(this$static){
  ...
  rowStyles_0 = initValues(_3Ljava_lang_String_2_classLit, 239, 1, ['dialogTop', 'dialogMiddle', 'dialogBottom']);
  this$static.decPanel = $DecoratorPanel(new DecoratorPanel, rowStyles_0, 1);
  this$static.decPanel.getStyleElement()['className'] = '';
  setStylePrimaryName($getStyleElement_1($getFirstChildElement(($clinit_55() , this$static.element_0))), 'gwt-DecoratedPopupPanel');
  ...
  $addDomHandler(this$static, mouseHandler, ($clinit_125() , $clinit_125() , TYPE_6));
  $addDomHandler(this$static, mouseHandler, ($clinit_133() , $clinit_133() , TYPE_10));
  $addDomHandler(this$static, mouseHandler, ($clinit_127() , $clinit_127() , TYPE_7));
  $addDomHandler(this$static, mouseHandler, ($clinit_131() , $clinit_131() , TYPE_9));
  $addDomHandler(this$static, mouseHandler, ($clinit_129() , $clinit_129() , TYPE_8));
  return this$static;
}
...
function $onMouseMove(this$static, x, y){
  ...
  if (this$static.dragging) {
    absX = x + $getAbsoluteLeft(($clinit_55() , this$static.element_0));
...
function onPreviewNativeEvent_0(event_0){
  var nativeEvent;
  nativeEvent = event_0.nativeEvent;
  !event_0.isCanceled && $eventGetTypeInt(($clinit_55() , event_0.nativeEvent).type) == 4 && $isCaptionEvent(this, nativeEvent) && (($clinit_55() , nativeEvent).returnValue = false , undefined);
}

function setText_2(text){
  ($clinit_55() , this.caption.element_0).innerText = text || '';
}
...
function $Label_0(this$static, text){
  $Label(this$static);
  ($clinit_55() , this$static.element_0).innerText = text || '';
  return this$static;
}
...
function $DockPanel(this$static){
  ...
  this$static.horzAlign = ($clinit_262() , ALIGN_DEFAULT);
  this$static.vertAlign = ($clinit_266() , ALIGN_TOP);
...
function $realizeTable(this$static){
  ...
  rows = initDim(_3Lcom_google_gwt_user_client_ui_DockPanel$TmpRow_2_classLit, 222, 30, rowCount, 0);
  for (i = 0; i < rowCount; ++i) {
    rows[i] = new DockPanel$TmpRow;
    rows[i].tr = $createElement(($clinit_55() , $doc), 'tr');
  ...
  for (it = $WidgetCollection$WidgetIterator(new WidgetCollection$WidgetIterator, this$static.children_0); it.index_0 < it.this$0.size - 1;) {
    ...
    td = $createElement(($clinit_55() , $doc), 'td');
    layout.td = td;
...
function $DockPanel$LayoutData(this$static, dir){
  this$static.hAlign = ($clinit_262() , ALIGN_DEFAULT).textAlignString;
  this$static.vAlign = ($clinit_266() , ALIGN_TOP).verticalAlignString;
...
function addChangeHandler(handler){
  return $addDomHandler(this, handler, ($clinit_91() , $clinit_91() , TYPE_1));
}
...
function $HTMLTable(this$static){
  ...
  this$static.tableElem = $createElement(($clinit_55() , $doc), 'table');
...
function $getWidgetImpl(this$static, row, column){
  ...
  child = $getFirstChildElement(($clinit_55() , e));
  if (!child) {
    return null;
  }
   else {
...
function $internalClearCell(this$static, td, clearInnerHTML){
  ...
  maybeChild = $getFirstChildElement(($clinit_55() , td));
  widget = null;
...
function createCell(){
  return $createElement(($clinit_55() , $doc), 'td');
}
...
function $prepareRow(this$static, row){
  ...
  for (i = rowCount; i <= row; ++i) {
    ...
    tr = $createElement(($clinit_55() , $doc), 'tr');
...
function $fireSubmitEvent(this$static){
  var event_0;
  event_0 = ($clinit_252() , new FormPanel$SubmitEvent);
  !!this$static.handlerManager && $fireEvent_0(this$static.handlerManager, event_0);
...
function onAttach_1(){
  ...
  if (this.frameName != null) {
    dummy = $createElement(($clinit_55() , $doc), 'div');
...
function $prepareColumnGroup(this$static){
  if (!this$static.columnGroup) {
    this$static.columnGroup = $createElement(($clinit_55() , $doc), 'colgroup');
...
function $HorizontalPanel(this$static){
  ...
  this$static.horzAlign = ($clinit_262() , ALIGN_DEFAULT);
  this$static.vertAlign = ($clinit_266() , ALIGN_TOP);
  this$static.tableRow = $createElement(($clinit_55() , $doc), 'tr');
...
function $add_8(this$static, w){
  var td, td_0;
  td = (td_0 = $createElement(($clinit_55() , $doc), 'td') , td_0['align'] = this$static.horzAlign.textAlignString , td_0.style['verticalAlign'] = this$static.vertAlign.verticalAlignString , td_0);
...
function $remove_5(this$static, w){
  ...
  td = (parent_0 = ($clinit_55() , w.getElement_0()).parentNode , (!parent_0 || parent_0.nodeType != 1) && (parent_0 = null) , parent_0);
  removed = $remove_1(this$static, w);
...
function $Image$ClippedState(this$static, image, url, left, top_0, width, height){
  ...
  this$static.height_0 = height;
  this$static.url = url;
  $replaceElement_0(image, (tmp = $createElement(($clinit_55() , $doc), 'span') , tmp.innerHTML = (style_1 = 'width: ' + width + 'px; height: ' + height + 'px; background: url(' + url + ') no-repeat ' + -left + 'px ' + -top_0 + 'px' , "<img src='" + $moduleBase + "clear.cache.gif' style='" + style_1 + "' border='0'>") || '' , $getFirstChildElement(tmp)));
...
function $Image$UnclippedState(this$static, image){
  $replaceElement_0(image, $createElement(($clinit_55() , $doc), 'img'));
...
function $Image$UnclippedState_0(this$static, image, url){
  ...
  ($clinit_55() , image.element_0).src = url;
  return this$static;
}
...
function getUrl_0(image){
  return ($clinit_55() , image.element_0).src;
}
...
function $onResize(){
  ...
  null.nullMethod(0 + ($clinit_79() , 'px'));
  null.nullMethod('0px');
...
function values_3(){
  $clinit_281();
  return initValues(_3Lcom_google_gwt_user_client_ui_PopupPanel$AnimationType_2_classLit, 223, 31, [CENTER_0, ONE_WAY_CORNER, ROLL_DOWN]);
}
...
function $onComplete(this$static){
  if (!this$static.showing) {
    ...
    $remove_2(($clinit_284() , get_0(null)), this$static.curPanel);
  }
...
function $onInstantaneousRun(this$static){
  ...
  if (this$static.showing) {
    ...
    $add_4(($clinit_284() , get_0(null)), this$static.curPanel);
  }
   else {
    $remove_2(($clinit_284() , get_0(null)), this$static.curPanel);
  }
...
function $setState_0(this$static, showing){
  ...
  this$static.curPanel.animType != ($clinit_281() , CENTER_0) && !showing && (animate = false);
  this$static.showing = showing;
  if (animate) {
    if (showing) {
      $maybeShowGlass(this$static);
...
function $WidgetCollection(this$static, parent_0){
  this$static.parent_0 = parent_0;
  this$static.array = initDim(_3Lcom_google_gwt_user_client_ui_Widget_2_classLit, 225, 33, 4, 0);
  return this$static;
}
...
function $insert_0(this$static, w, beforeIndex){
  ...
  if (this$static.size == this$static.array.length) {
    newArray = initDim(_3Lcom_google_gwt_user_client_ui_Widget_2_classLit, 225, 33, this$static.array.length * 2, 0);
...
function $createFocusable(){
  var e;
  e = $createElement(($clinit_55() , $doc), 'div');
  e.tabIndex = 0;
  return e;
}
...
function $getStyleElement_1(popup){
  var parent_0;
  return parent_0 = ($clinit_55() , popup).parentNode , (!parent_0 || parent_0.nodeType != 1) && (parent_0 = null) , parent_0;
}
...
function $generateText(this$static, curProgress){
  if (this$static.textFormatter) {
    return ($clinit_55() , this$static.textFormatter.this$0.fileNameLabel.element_0).innerText + '  (' + ~~Math.max(Math.min(curProgress, 2147483647), -2147483648) + ' %)';
  }
   else {
...
function $clinit_327(){
  ...
  impl_0 = ($clinit_341() , $clinit_341() , impl_1);
}
...
function build(node){
  ...
  nodeType = ($clinit_341() , out = node.nodeType , out == null?-1:out);
  switch (nodeType) {
    case 2:
...
function toString_11(){
  var jsNode;
  return $clinit_341() , jsNode = this.getJsObject() , jsNode.xml;
}
...
function toString_12(){
  ...
  x = $split(($clinit_341() , this.jsObject.data), '(?=[;&<>\'"])', -1);
...
function toString_13(){
  ...
  $append_0(b, ($clinit_341() , this.jsObject.data));
  $append(b.data_0, ']]>');
  return $toString_2(b.data_0);
}
...
function toString_15(){
  var b, i;
  b = $StringBuffer(new StringBuffer);
  for (i = 0; i < ($clinit_341() , this.jsObject.length); ++i) {
...
function $clinit_341(){
  ...
  impl_1 = ($clinit_342() , $clinit_341() , new XMLParserImplIE6);
}
...
function $BaseUploadStatus(this$static){
  ...
  this$static.cancelCfg = ($clinit_367() , DEFAULT_CANCEL_CFG);
  this$static.i18nStrs = new IUploadStatus_UploadStatusConstants_;
  this$static.status_0 = ($clinit_369() , UNINITIALIZED);
...
function $setStatus(this$static, stat){
  ...
  switch (stat.ordinal) {
    ...
    case 5:
      ...
      !this$static.cancelCfg.contains_0(($clinit_368() , STOP_CURRENT)) && (this$static.cancelLabel.getElement_0().style.display = 'none' , undefined);
      break;
    case 9:
    case 7:
      $updateStatusPanel(this$static, false, this$static.i18nStrs.uploadStatusSuccess());
      !this$static.cancelCfg.contains_0(($clinit_368() , REMOVE_REMOTE)) && (this$static.cancelLabel.getElement_0().style.display = 'none' , undefined);
      break;
    case 1:
    ...
    case 0:
      ...
      this$static.cancelCfg.contains_0(($clinit_368() , REMOVE_CANCELLED_FROM_LIST)) && $removeFromParent(this$static.getWidget());
      break;
    case 4:
...
function $updateStatusPanel(this$static, showProgress, message){
  ...
  ($clinit_55() , this$static.statusLabel.element_0).innerText = message || '';
  $setVisible(this$static.cancelLabel, this$static.hasCancelActions && !this$static.cancelCfg.contains_0(($clinit_368() , DISABLED)));
}
...
function setError(msg){
  $setStatus(this, ($clinit_369() , ERROR));
  $wnd.alert($replaceAll(msg, '\\\\n', '\\n'));
}

function setFileName(name_0){
  ($clinit_55() , this.fileNameLabel.element_0).innerText = name_0 || '';
}
...
function setProgress_0(done, total){
  ...
  ($clinit_55() , this.statusMsg.element_0).innerText = percent + '%' || '';
}
...
function $DecoratedFileUpload(this$static, text){
  ...
  this$static.impl = ($clinit_350() , new DecoratedFileUpload$DecoratedFileUploadImplClick);
...
function addChangeHandler_0(handler){
  return $addDomHandler(this.input, handler, ($clinit_91() , $clinit_91() , TYPE_1));
}
...
function $DecoratedFileUpload$FileUploadWithMouseEvents(this$static){
  var e;
  this$static.element_0 = (e = ($clinit_55() , $doc).createElement('INPUT') , e.type = 'file' , e);
...
function $IFileInput$ButtonFileInput(this$static){
  $DecoratedFileUpload(this$static, ($clinit_393() , 'Choose a file to upload ...'));
  return this$static;
}
...
function values_4(){
  $clinit_359();
  return initValues(_3Lgwtupload_client_IFileInput$FileInputType_2_classLit, 227, 34, [ANCHOR, BROWSER_INPUT, BUTTON, LABEL]);
}
...
function $IFileInput$LabelFileInput(this$static){
  ...
  $addDomHandler(this$static.input, $IFileInput$LabelFileInput$1(new IFileInput$LabelFileInput$1, this$static), ($clinit_91() , $clinit_91() , TYPE_1));
  return this$static;
}
...
function $clinit_367(){
  ...
  DEFAULT_CANCEL_CFG = of(($clinit_368() , REMOVE_REMOTE), initValues(_3Lgwtupload_client_IUploadStatus$CancelBehavior_2_classLit, 229, 36, [STOP_CURRENT]));
  of(STOP_CURRENT, initValues(_3Lgwtupload_client_IUploadStatus$CancelBehavior_2_classLit, 229, 36, [REMOVE_REMOTE, REMOVE_CANCELLED_FROM_LIST]));
}
...
function values_5(){
  $clinit_368();
  return initValues(_3Lgwtupload_client_IUploadStatus$CancelBehavior_2_classLit, 229, 36, [DISABLED, REMOVE_CANCELLED_FROM_LIST, REMOVE_REMOTE, STOP_CURRENT]);
}
...
function values_6(){
  $clinit_369();
  return initValues(_3Lgwtupload_client_IUploadStatus$Status_2_classLit, 230, 37, [CANCELED, CANCELING, DELETED, DONE, ERROR, INPROGRESS, QUEUED, REPEATED, SUBMITING, SUCCESS, UNINITIALIZED, CHANGED]);
}
...
function getXmlNodeValue(doc, tag){
  ...
  list = $NodeListImpl(new NodeListImpl, ($clinit_341() , doc.jsObject.selectNodes(".//*[local-name()='" + tag + "']")));
...
function $MultiUploader_0(this$static, type, status_0){
  ...
  this$static.i18nStrs = ($clinit_393() , I18N_CONSTANTS);
...
function $getNonErroneousUploads(this$static){
  ...
  for (u$iterator = $AbstractList$IteratorImpl(new AbstractList$IteratorImpl, this$static.uploaders.arrayList); u$iterator.i < u$iterator.this$0.size_0();) {
    ...
    (u.getStatus() == ($clinit_369() , SUCCESS) || u.getStatus() == INPROGRESS || u.getStatus() == QUEUED || u.getStatus() == SUBMITING) && ++ret;
  }
  return ret;
}
...
function $newUploaderInstance(this$static){
  ...
  if (this$static.currentUploader) {
    ...
    if (status_0 == ($clinit_369() , UNINITIALIZED)) {
      return;
    }
...
function getStatus_0(){
  ...
  for (uploader$iterator = $AbstractList$IteratorImpl(new AbstractList$IteratorImpl, this.uploaders.arrayList); uploader$iterator.i < uploader$iterator.this$0.size_0();) {
    ...
    if (stat == ($clinit_369() , INPROGRESS) || stat == QUEUED || stat == SUBMITING) {
      return INPROGRESS;
    }
  }
  if (this.uploaders.arrayList.size <= 1) {
    return $clinit_369() , UNINITIALIZED;
  }
   else {
    return $clinit_369() , DONE;
  }
}
...
function onStatusChanged(uploader){
  var u, w;
  u = uploader;
  if (u.statusWidget.getStatus() == ($clinit_369() , CHANGED)) {
    ...
    w.getElement_0().style['position'] = ($clinit_74() , 'absolute');
    w.getElement_0().style['left'] = -4000 + ($clinit_79() , 'px');
...
function $setUrl_0(this$static, url){
  ...
  $add_4(($clinit_284() , get_0(null)), this$static);
  this$static.element_0.style.display = 'none';
}
...
function $Uploader_0(this$static, type, form){
  ...
  $addHandler(this$static.uploadForm, this$static.onSubmitFormHandler, ($clinit_252() , !TYPE_17 && (TYPE_17 = $GwtEvent$Type(new GwtEvent$Type)) , TYPE_17));
...
function $addToQueue(this$static){
  this$static.statusWidget.setStatus(($clinit_369() , QUEUED));
...
function $cancel_2(this$static){
  ...
  if (this$static.finished && !this$static.uploading) {
    if (this$static.successful) {
      try {
        reqBuilder = $RequestBuilder(new RequestBuilder, ($clinit_159() , GET), $composeURL(this$static, initValues(_3Ljava_lang_String_2_classLit, 239, 1, ['remove=' + this$static.fileInput.getName()])));
      ...
      this$static.statusWidget.setStatus(($clinit_369() , DELETED));
    }
    return;
  }
  ...
  if (this$static.uploading) {
    ...
    this$static.statusWidget.setStatus(($clinit_369() , CANCELING));
  }
   else {
...
function $cancelUpload(this$static, msg){
  ...
  $uploadFinished(this$static);
  this$static.statusWidget.setStatus(($clinit_369() , ERROR));
...
function $fileUrl(this$static){
  return $composeURL(this$static, initValues(_3Ljava_lang_String_2_classLit, 239, 1, ['show=' + this$static.fileInput.getName()]));
}

function $getData(this$static){
  return {url:$composeURL(this$static, initValues(_3Ljava_lang_String_2_classLit, 239, 1, ['show=' + this$static.fileInput.getName()])), name:this$static.fileInput.getName(), filename:this$static.fileInput.getFilename(), basename:$replaceAll(this$static.fileInput.getFilename(), '^.*[/\\\\]', ''), response:this$static.serverResponse, status:this$static.statusWidget.getStatus().name_0};
}
...
function $onChangeInput(this$static){
  ...
  this$static.statusWidget.setStatus(($clinit_369() , CHANGED));
  for (handler$iterator = $AbstractList$IteratorImpl(new AbstractList$IteratorImpl, this$static.onChangeHandlers.arrayList); handler$iterator.i < handler$iterator.this$0.size_0();) {
    ...
    $onChangeImpl(handler.val$jsChange.jsobject, {url:$composeURL(this$static, initValues(_3Ljava_lang_String_2_classLit, 239, 1, ['show=' + this$static.fileInput.getName()])), name:this$static.fileInput.getName(), filename:this$static.fileInput.getFilename(), basename:$replaceAll(this$static.fileInput.getFilename(), '^.*[/\\\\]', ''), response:this$static.serverResponse, status:this$static.statusWidget.getStatus().name_0});
  }
}
...
function $parseAjaxResponse(this$static, responseTxt){
  ...
  doc = null;
  try {
    doc = ($clinit_327() , $parse(impl_0, responseTxt));
...
function $sendAjaxRequestToCancelCurrentUpload(this$static){
  var reqBuilder;
  reqBuilder = $RequestBuilder(new RequestBuilder, ($clinit_159() , GET), $composeURL(this$static, initValues(_3Ljava_lang_String_2_classLit, 239, 1, ['cancel=true'])));
...
function $sendAjaxRequestToGetBlobstorePath(this$static){
  var reqBuilder;
  reqBuilder = $RequestBuilder(new RequestBuilder, ($clinit_159() , GET), $composeURL(this$static, initValues(_3Ljava_lang_String_2_classLit, 239, 1, ['blobstore=true'])));
...
function $sendAjaxRequestToValidateSession(this$static){
  var reqBuilder;
  reqBuilder = $RequestBuilder(new RequestBuilder, ($clinit_159() , GET), $composeURL(this$static, initValues(_3Ljava_lang_String_2_classLit, 239, 1, ['new_session=true'])));
  $setTimeoutMillis(reqBuilder, 10000);
...
function $setValidExtensions(this$static, validExtensions){
  ...
  if (validExtensions == null) {
    this$static.validExtensions = initDim(_3Ljava_lang_String_2_classLit, 239, 1, 0, 0);
    return;
  }
  this$static.validExtensions = initDim(_3Ljava_lang_String_2_classLit, 239, 1, validExtensions.length, 0);
...
function $update_0(this$static){
  ...
  try {
    ...
    reqBuilder = $RequestBuilder(new RequestBuilder, ($clinit_159() , GET), $composeURL(this$static, initValues(_3Ljava_lang_String_2_classLit, 239, 1, ['filename=' + this$static.fileInput.getName(), 'c=' + this$static.requestsCounter++])));
    $setTimeoutMillis(reqBuilder, 10000);
  ...
  if (this$static.successful) {
    if (this$static.avoidRepeatedFiles) {
      if (!$containsKey(fileDone.map, this$static.fileInput.getFilename())) {
        ...
        this$static.statusWidget.setStatus(($clinit_369() , SUCCESS));
      }
    }
     else {
      this$static.statusWidget.setStatus(($clinit_369() , SUCCESS));
    ...
    this$static.cancelled?this$static.statusWidget.setStatus(($clinit_369() , CANCELED)):this$static.statusWidget.setStatus(($clinit_369() , ERROR));
...
function fileUrl_0(){
  return $composeURL(this, initValues(_3Ljava_lang_String_2_classLit, 239, 1, ['show=' + this.fileInput.getName()]));
}
...
function getData_2(){
  return {url:$composeURL(this, initValues(_3Ljava_lang_String_2_classLit, 239, 1, ['show=' + this.fileInput.getName()])), name:this.fileInput.getName(), filename:this.fileInput.getFilename(), basename:$replaceAll(this.fileInput.getFilename(), '^.*[/\\\\]', ''), response:this.serverResponse, status:this.statusWidget.getStatus().name_0};
}
...
function log(msg, e){
  ...
  if (!mlog) {
    if ((ensureParameterMap() , dynamicCast($get_2(paramMap, 'log'), 1)) != null) {
      mlog = $HTML(new HTML);
      $add_4(($clinit_284() , get_0(null)), mlog);
      log(msg, e);
    }
  }
   else {
    html = $replaceAll(msg + '\n' + (e?e.getMessage():''), '\n', '<br/>');
    $setHTML_1(mlog, ($clinit_55() , mlog.element_0).innerHTML + html);
  }
}
...
function onFinishUpload_0(){
  $onFinishUpload(this);
  this.statusWidget.getStatus() == ($clinit_369() , REPEATED) && this.statusWidget.setError(this.i18nStrs.uploaderAlreadyDone());
...
function run_6(){
  if ($isTheFirstInQueue(this.this$0)) {
    $cancel_0(this);
    this.firstTime = true;
    this.this$0.statusWidget.setStatus(($clinit_369() , SUBMITING));
...
function $onSubmit(this$static, event_0){
  ...
  if (!this$static.this$0.finished && this$static.this$0.uploading) {
    ...
    this$static.this$0.statusWidget.setStatus(($clinit_369() , CANCELED));
    return;
  }
  if (!this$static.this$0.autoSubmit && ($clinit_393() , fileQueue).arrayList.size > 0) {
    this$static.this$0.statusWidget.setError(this$static.this$0.i18nStrs.uploaderActiveUpload());
    event_0.canceled = true;
    return;
  }
  if (this$static.this$0.avoidRepeatedFiles && $containsKey(($clinit_393() , fileDone).map, this$static.this$0.fileInput.getFilename())) {
    this$static.this$0.statusWidget.setStatus(($clinit_369() , REPEATED));
  ...
  if (this$static.this$0.autoSubmit) {
    ...
    this$static.this$0.statusWidget.setStatus(($clinit_369() , INPROGRESS));
    this$static.this$0.lastData = ($clinit_393() , fromDouble($getTime0($Date(new Date_0))));
  }
}
...
function run_7(){
  ...
  this.this$1.this$0.statusWidget.setStatus(($clinit_369() , INPROGRESS));
  this.this$1.this$0.lastData = ($clinit_393() , fromDouble($getTime0($Date(new Date_0))));
}
...
function onResponseReceived(request, response){
  ...
  url = null;
  try {
    url = getXmlNodeValue(($clinit_327() , $parse(impl_0, text)), 'blobpath');
  }
   catch ($e0) {
    $e0 = caught_0($e0);
    if (instanceOf($e0, 77)) {
...
function onError_0(request, exception){
  ...
  this.this$0.statusWidget.setStatus(($clinit_369() , CANCELED));
}

function onResponseReceived_0(request, response){
  this.this$0.statusWidget.getStatus() == ($clinit_369() , CANCELING) && $scheduleRepeating(this.this$0.updateStatusTimer, 3000);
}
...
function onError_1(request, exception){
  this.this$0.statusWidget.setStatus(($clinit_369() , DELETED));
  log('onCancelReceivedCallback onError: ', exception);
}

function onResponseReceived_1(request, response){
  this.this$0.statusWidget.setStatus(($clinit_369() , DELETED));
  $remove_11(($clinit_393() , fileDone).map, this.this$0.fileInput.getFilename()) != null;
}
...
function onChange_0(event_0){
  ...
  if (this.this$0.avoidRepeatedFiles && $containsKey(($clinit_393() , fileDone).map, this.this$0.fileInput.getFilename())) {
    this.this$0.statusWidget.setStatus(($clinit_369() , REPEATED));
    return;
  }
...
function onResponseReceived_2(request, response){
  ...
  try {
    s = getXmlNodeValue(($clinit_327() , $parse(impl_0, response.val$xmlHttpRequest.responseText)), 'blobstore');
...
function $Uploader$FormFlowPanel(this$static){
  $FormPanel(this$static, $createElement(($clinit_55() , $doc), 'form'), true);
...
function valueOf(i){
  ...
  if (i > -129 && i < 128) {
    rebase = i + 128;
    result = ($clinit_432() , boxedValues_0)[rebase];
...
function $clinit_432(){
  ...
  boxedValues_0 = initDim(_3Ljava_lang_Integer_2_classLit, 235, 42, 256, 0);
}
...
function $split(this$static, regex, maxMatch){
  ...
  var jr = initDim(_3Ljava_lang_String_2_classLit, 239, 1, out.length, 0);
...
function $ArrayList(this$static){
  this$static.array = initDim(_3Ljava_lang_Object_2_classLit, 237, 0, 0, 0);
  return this$static;
}
...
function $clinit_469(){
  ...
  DAYS = initValues(_3Ljava_lang_String_2_classLit, 239, 1, ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat']);
  MONTHS = initValues(_3Ljava_lang_String_2_classLit, 239, 1, ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec']);
}
...
function setFileName_0(name_0){
  !this.asDialog && (($clinit_55() , this.fileNameLabel.element_0).innerText = name_0 || '' , undefined);
  ($clinit_55() , this.prg.textLabel.element_0).innerText = name_0 || '';
}
...
function uploadStatusCanceled_1(){
  return $or(initValues(_3Ljava_lang_String_2_classLit, 239, 1, [dynamicCast($get_2(this.strs, 'uploadStatusCanceled'), 1), 'Canceled']));
}

function uploadStatusCanceling_1(){
  return $or(initValues(_3Ljava_lang_String_2_classLit, 239, 1, [dynamicCast($get_2(this.strs, 'uploadStatusCanceling'), 1), 'Canceling ...']));
}

function uploadStatusDeleted_1(){
  return $or(initValues(_3Ljava_lang_String_2_classLit, 239, 1, [dynamicCast($get_2(this.strs, 'uploadStatusDeleted'), 1), 'Deleted']));
}

function uploadStatusError_1(){
  return $or(initValues(_3Ljava_lang_String_2_classLit, 239, 1, [dynamicCast($get_2(this.strs, 'uploadStatusError'), 1), 'Error']));
}

function uploadStatusInProgress_1(){
  return $or(initValues(_3Ljava_lang_String_2_classLit, 239, 1, [dynamicCast($get_2(this.strs, 'uploadStatusInProgress'), 1), 'In progress']));
}

function uploadStatusQueued_1(){
  return $or(initValues(_3Ljava_lang_String_2_classLit, 239, 1, [dynamicCast($get_2(this.strs, 'uploadStatusQueued'), 1), 'Queued']));
}

function uploadStatusSubmitting_1(){
  return $or(initValues(_3Ljava_lang_String_2_classLit, 239, 1, [dynamicCast($get_2(this.strs, 'uploadStatusSubmitting'), 1), 'Submitting form ...']));
}

function uploadStatusSuccess_1(){
  return $or(initValues(_3Ljava_lang_String_2_classLit, 239, 1, [dynamicCast($get_2(this.strs, 'uploadStatusSuccess'), 1), 'Done']));
}

function uploaderActiveUpload_0(){
  return $or(initValues(_3Ljava_lang_String_2_classLit, 239, 1, [dynamicCast($get_2(this.strs, 'uploaderActiveUpload'), 1), 'There is already an active upload, try later.']));
}

function uploaderAlreadyDone_0(){
  return $or(initValues(_3Ljava_lang_String_2_classLit, 239, 1, [dynamicCast($get_2(this.strs, 'uploaderAlreadyDone'), 1), 'This file was already uploaded.']));
}
...
function uploaderBrowse_0(){
  return $or(initValues(_3Ljava_lang_String_2_classLit, 239, 1, [dynamicCast($get_2(this.strs, 'uploadBrowse'), 1), 'Choose a file to upload ...']));
}

function uploaderInvalidExtension_0(){
  return $or(initValues(_3Ljava_lang_String_2_classLit, 239, 1, [dynamicCast($get_2(this.strs, 'uploaderInvalidExtension'), 1), 'Invalid file.\nOnly these types are allowed:\n']));
}

function uploaderSend_0(){
  return $or(initValues(_3Ljava_lang_String_2_classLit, 239, 1, [dynamicCast($get_2(this.strs, 'uploaderSend'), 1), 'Send']));
}

function uploaderServerError_0(){
  return $or(initValues(_3Ljava_lang_String_2_classLit, 239, 1, [dynamicCast($get_2(this.strs, 'uploaderServerError'), 1), 'Invalid server response. Have you configured correctly your application in the server side?']));
}

function uploaderServerUnavailable_0(){
  return $or(initValues(_3Ljava_lang_String_2_classLit, 239, 1, [dynamicCast($get_2(this.strs, 'uploaderServerUnavailable'), 1), 'Unable to contact with the server: ']));
}

function uploaderTimeout_0(){
  return $or(initValues(_3Ljava_lang_String_2_classLit, 239, 1, [dynamicCast($get_2(this.strs, 'uploaderTimeout'), 1), 'Timeout sending the file:\n perhaps your browser does not send files correctly,\n your session has expired,\n or there was a server error.\nPlease try again.']));
}
...
function $keys(this$static){
  ...
  ret = initDim(_3Ljava_lang_String_2_classLit, 239, 1, a.length, 0);
...
function $onCancel_0(this$static, u){
  $onChangeImpl(this$static.val$jsChange.jsobject, {url:$composeURL(u, initValues(_3Ljava_lang_String_2_classLit, 239, 1, ['show=' + u.fileInput.getName()])), name:u.fileInput.getName(), filename:u.fileInput.getFilename(), basename:$replaceAll(u.fileInput.getFilename(), '^.*[/\\\\]', ''), response:u.serverResponse, status:u.statusWidget.getStatus().name_0});
}
...
function onStatusChanged_0(u){
  $onChangeImpl(this.val$jsChange.jsobject, {url:$composeURL(u, initValues(_3Ljava_lang_String_2_classLit, 239, 1, ['show=' + u.fileInput.getName()])), name:u.fileInput.getName(), filename:u.fileInput.getFilename(), basename:$replaceAll(u.fileInput.getFilename(), '^.*[/\\\\]', ''), response:u.serverResponse, status:u.statusWidget.getStatus().name_0});
}
...
function $PreloadImage(this$static, prop_0){
  ...
  this$static.thisInstance = this$static;
  this$static.loadHandler = $addHandler(this$static, this$static.imgLoadListener, ($clinit_122() , $clinit_122() , TYPE_5));
  this$static.errHandler = $addHandler(this$static, this$static.imgErrorListener, ($clinit_96() , $clinit_96() , TYPE_2));
...
function $Upload(this$static, prop_0){
  ...
  !this$static.panel && (this$static.panel = ($clinit_284() , get_0(null)));
